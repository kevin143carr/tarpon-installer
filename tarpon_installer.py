...
def print_banner(file=None) -> None:
    print("******************************************************************", file=file)
    print("******************************************************************", file=file)
    print(" ><###> Tarpon Installer <###>< is a local and remote install creator.", file=file)
    print(" Licensed under PolyForm Noncommercial 1.0.0 starting with v5.1.0.", file=file)
    print(" Releases through v5.0.5 remain available under the MIT license", file=file)
    print(" that applied when those versions were published.", file=file)
...
class mainClass:
    ...
    def main(self, ini_info: iniInfo) -> None:
        ...
        self.logger.info("******************************************************************")
        self.logger.info("******************************************************************")
        self.logger.info(" ><###> Tarpon Installer <###>< is a local and remote install creator.")
        self.logger.info(" Licensed under PolyForm Noncommercial 1.0.0 starting with v5.1.0.")
        self.logger.info(" Releases through v5.0.5 remain available under the MIT license")
        self.logger.info(" that applied when those versions were published.")
